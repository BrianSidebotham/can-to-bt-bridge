/**
    ...
    generic circular buffer (malloc based)
...
*/
circular_buffer_t* Cbu_create(int elements, size_t element_size)
{
    /* Result is null on error */
    circular_buffer_t* result = NULL;

    /* Allocate a new circular buffer structure */
    result = malloc(sizeof(circular_buffer_t));
    ...
    if (result != NULL)
    {
        ...
        result->p__data = malloc(elements * element_size);
...
*/
bool Cbu_put(circular_buffer_t* cb, void* data_in)
{
    bool result = false;
...
*/
bool Cbu_get(circular_buffer_t* cb, void* data_out)
{
    bool result = false;
