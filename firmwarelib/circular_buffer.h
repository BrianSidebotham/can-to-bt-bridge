...
extern circular_buffer_t* Cbu_create(int elements, size_t element_size);
extern bool Cbu_put(circular_buffer_t* cb, void* data_in);
extern bool Cbu_get(circular_buffer_t* cb, void* data_out);
